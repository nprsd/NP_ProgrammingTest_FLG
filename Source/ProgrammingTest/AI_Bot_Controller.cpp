...
void AAI_Bot_Controller::Tick(float DeltaSeconds)
{
	...
	{
		AProgrammingTestCharacter* Player = Cast<AProgrammingTestCharacter>(UGameplayStatics::GetPlayerCharacter(GetWorld(), 0));
...
{
	DistanceToPlayer = GetPawn()->GetDistanceTo(DetectedPawns[0]);
